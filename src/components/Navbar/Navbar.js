    ...
    <>
      <nav className='Navbar'>
        <div className='container'>
          ...
          <form onSubmit={handleSearchSubmit} className={`Search ${clicked ? 'active' : ''}`} ref={searchRef}>
            <input
              type='text'
            ...
            />
            <FontAwesomeIcon icon='search' className='search-icon' onClick={handleSearchSubmit} />
          </form>
